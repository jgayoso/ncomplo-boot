...
public class SMAuthenticationProvider implements AuthenticationProvider {

    private static final Logger logger = Logger.getLogger(SMAuthenticationProvider.class);
